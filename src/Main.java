...
public class Main {
    ...
    public static void mostrarMenuColor() {
        ...
        System.out.println("*******");
        System.out.println("1. Blanco" + " " + simboloPiezas.colorNegro);
        System.out.println("2. Negro" + " " + simboloPiezas.colorBlanco);
    ...
    public static boolean validacionPosicion(String posicionInicial){
        ...
        if (posicionInicial.length() != 2){
            ...
            if (!Character.isLetter(primerCaracter) || !Character.isDigit(segundoCaracter)){
                System.err.println("ERROR. Debes introducir una posición válida.");
                resultado = false;
            } else {
                ...
                if (primerCaracter < 65 || primerCaracter > 72){
                    System.err.println("ERROR. La posición inicial debe de contener una letra en mayúsculas y entre la A y la H.");
                    resultado = false;
                } else if (numero < 1 || numero > 8) {
                    System.err.println("ERROR. El numero de la posición inicial debe ser entre 1 y 8.");
                    resultado = false;
                }
            }
        }
